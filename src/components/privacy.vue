<template>
    <div id="privacy">
        <h1>隐私政策</h1>
        <h3>引言</h3>
        <p>【CrazyE团队】（以下简称“我们”）深知个人信息对您的重要性，并会尽全力保护您的个人信息安全可靠。我们致力于维持您对我们的信任，恪守以下原则，保护您的个人信息：权责一致原则、目的明确原则、选择同意原则、最少够用原则、确保安全原则、主体参与原则、公开透明原则等。同时，我们承诺，我们将按业界成熟的安全标准，采取相应的安全保护措施来保护您的个人信息。</p>
        ...
        <h6>注册成为用户</h6>
        <p>
            为完成创建账号，您需提供以下信息：您的姓名、您的手机号、创建的用户名和密码。 您提供的上述信息，将在您使用本服务期间持续授权我们使用。在您注销账号时，我们将停止使用并删除上述信息。 上述信息将存储于中华人民共和国境内。如需跨境传输，我们将会单独征得您的授权同意。
        </p>
        <h6>显示课程详细和课程安排</h6>
        <h6>考试信息和成绩信息</h6>
        <h6>成绩的分析功能</h6>
        <h5>2.为您提供考试安排与成绩和考试分析功能</h5>
        <h5>3.开展内部数据分析和研究，第三方SDK统计服务和软件崩溃报告，改善我们的产品或服务</h5>
        <p>
        ...
        <p>
            ...
            <br/>我们可能会根据法律法规规定，或按政府主管部门的强制性要求，对外共享您的个人信息。

            <br/>与授权合作伙伴共享
        </p>
        <p>
            仅为实现本隐私权政策中声明的目的，我们的某些服务将由授权合作伙伴提供。我们可能会与合作伙伴共享您的某些个人信息，以提供更好的客户服务和用户体验。例如，我们聘请来提供第三方数据统计、分析和崩溃统计服务的公司可能需要采集和访问个人和设备数据以进行数据统计和分析。在这种情况下，这些公司 必须遵守我们的数据隐私和安全要求。我们仅会出于合法、正当、必要、特定、明确的目的共享您的个人信息，并且只会共享提供服务所必要的个人信息。
        </p>
        <p>
        ...
        <p>
            ...
            如涉及到个人信息转让，我们会在要求新的持有您个人信息的公司、组织继续受此隐私政策的约束，否则我们将要求该公司、组织重新向您征求授权同意。
        </p>
        <h5>
            3.公开披露
        </h5>
        <h6>我们仅会在以下情况下，公开披露您的个人信息：</h6>
        <p>
            获得您明确同意后。
        ...
        <h6>按照中国相关的法律、法规、标准，以及其他国家、地区的通行做法，我们保障您对自己的个人信息行使以下权利：</h6>
        <h5>1.访问您的个人信息</h5>
        <p>
            您有权访问您的个人信息，法律法规规定的例外情况除外。如果您想行使数据访问权，可以通过以下方式自行访问：
        </p>
        <p>
            账户信息——如果您希望访问或编辑您的账户中的个人资料信息和支付信息、更改您的密码、添加安全信息或关闭您的账户等，您可以通过应用程序执行此类操作。
            <br>课程信息——您可以在应用程序中访问您的课程详情和课程安排
            <br/>考试信息——您可以在应用程序中访问您的考试安排和考试成绩
        </p>
        <p>
            如果您无法通过应用软件访问这些个人信息，您可以随时发送电子邮件至crazye_team@163.com。我们将在30天内回复您的访问请求。
        </p>
        <p>
            对于您在使用我们的产品或服务过程中产生的其他个人信息，只要我们不需要过多投入，我们会向您提供。如果您想行使数据访问权，请发送电子邮件至crazye_team@163.com。
        </p>
        <h5>2.更正您的个人信息</h5>
        <p>
            当您发现我们处理的关于您的个人信息有错误时，您有权要求我们做出更正。您可以随时发送电子邮件至crazye_team@163.com。我们将在30天内回复您的更正请求。
        </p>
        <h5>3.删除您的个人信息</h5>
        <p>
            如果我们处理个人信息的行为违反法律法规
            <br/>如果我们收集、使用您的个人信息，却未征得您的同意
            <br/>如果我们处理个人信息的行为违反了与您的约定
            <br/>如果您不再使用我们的产品或服务，或您注销了账号
            <br/>如果我们不再为您提供产品或服务
        </p>
        <p>
        ...
        <p>
            当您从我们的服务中删除信息后，我们可能不会立即删除备份系统中相应的信息，但会在备份更新时删除这些信息，同时我们可能不会立即从系统日志中删除相应的信息，但会在定期删除日志时同时删除这些信息。
        </p>
        <h5>4.改变您授权同意的范围</h5>
        <p>
            每个业务功能需要一些基本的个人信息才能得以完成（见本策略“第一部分”）。对于额外收集的个人信息的收集和使用，您可以随时给予或收回您的授权同意。

            您可以发送电子邮件至crazye_team@163.com，我们将在30天内回复您的请求。

            当您收回同意后，我们将不再处理相应的个人信息。但您收回同意的决定，不会影响此前基于您的授权而开展的个人信息处理。
        </p>
        <h5>5.个人信息主体注销账户</h5>
        <p>
            您随时可注销此前注册的账户，您可以发送电子邮件至crazye_team@163.com，我们将在30天内回复您的请求。
        ...
        <p>
            ...
            我们将在三十天内做出答复。如您不满意，您可以发送电子邮件至crazye_team@163.com，我们将在30天内回复您的请求。
        </p>
        <p>
